...
<script>
	...
	if(screen.width < 0){
		<?php $GLOBALS['thisScreen'] = 1?>
	}else{
		<?php $GLOBALS['thisScreen'] = 2?>
	}
</script>
	...
	<div class="page-container">
		...
		<section class="section page2">
			<div class="section-content-container">
				<div class="section-inner-wrap">
							...
							<?php if ($lang == '0') { ?>
								<li class="clearfix">
									...
									<h2  class="desc"><a href="<?php echo $gourl; ?>"><?php
													if ($row['description'] != '')
														echo ReStrLen($row['description'], 18);
													else
														echo '网站资料更新中...';
													?></a></h2>
					...
					<?php echo $dopage->GetList_Main(2); ?>
				</div>
			</div>
		</section>
		...
		<section class="section page8">
			<div class="home-contact">
				...
				<div class="clear"></div>
				<div style="width:100%; float:left; text-align:center; margin-top:10px; font-size:15px;">友情链接：（www.x6d.com） <?php
