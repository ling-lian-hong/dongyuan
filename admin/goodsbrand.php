...
<form id="form" name="form" method="post" action="">
	...
	function Show($id=0, $i=0)
	{
		...
		$dosql->Execute("SELECT * FROM `#@__goodsbrand` WHERE `parentid`=$id ORDER BY `orderid` ASC", $id);
