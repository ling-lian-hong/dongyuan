...
if($action == 'add')
{
	...
	$sql = "INSERT INTO `$tbname` (siteid, parentid, parentstr, classname,classname2,  linkurl, linkurl2, relinkurl, picurl, target, orderid, checkinfo) VALUES ('$cfg_siteid', '$parentid', '$parentstr', '$classname','$classname2', '$linkurl', '$linkurl2', '$relinkurl', '$picurl', '$target', '$orderid', '$checkinfo')";
