...
<body>
<div class="formHeader"> <span class="title">添加商品信息</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr class="nb">
			<td colspan="2" height="26" id="getattr"><div style="text-align:center;color:#9C0;">请选择商品分类获取自定义属性</div></td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"></div></td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="0" id="df"><?php if(isset($cid)) echo GetDiyField(4,$cid); ?></td>
		</tr>
		<tr>
			<td width="25%" height="40" align="right">运费承担：</td>
			<td><input type="radio" name="payfreight" id="payfreight" value="0"  />
				买家承担&nbsp;
				<input type="radio" name="payfreight" id="payfreight" value="1" checked="checked" />
				卖家承担</td>
		</tr>
		<tr>
			<td height="40" align="right">商品价格：</td>
			<td><input name="marketprice" type="text" id="marketprice" class="inputs" style="width:50px;" />
				市场价
				&nbsp;&nbsp;
				<input name="salesprice" type="text" id="salesprice" class="inputs" style="width:50px;" />
				销售价</td>
		</tr>
		<tr>
			<td height="40" align="right">商品编号：</td>
			<td><input name="goodsid" type="text" id="goodsid" class="input" /></td>
		</tr>
		<tr>
			<td height="40" align="right">商品重量：</td>
			<td><input name="weight" type="text" class="input" id="weight" />
				kg</td>
		</tr>
		<tr>
			<td height="40" align="right">库存数量：</td>
			<td><input name="housenum" type="text" id="housenum" class="input" /></td>
		</tr>
		<tr>
			<td height="40" align="right">库存警告：</td>
			<td><input name="housewarn" type="radio" value="true" />
				是
				&nbsp;
				<input name="housewarn" type="radio" value="false" checked="checked" />
				否</td>
		</tr>
		<tr>
			<td height="40" align="right">警告数量：</td>
			<td><input name="warnnum" type="text" id="warnnum" class="input" /></td>
		</tr>
		<tr class="nb">
			<td height="40" align="right">返点积分：</td>
			<td><input name="integral" type="text" class="input" id="integral" value="0" /></td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"> </div></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="linkurl" class="input" id="linkurl" /></td>
		</tr>
		<tr>
