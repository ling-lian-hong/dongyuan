...
<body>
<div class="topToolbar"> <span class="title">用户收藏管理</span> <a href="javascript:location.reload();" class="reload">刷新</a></div>
<form name="form" id="form" method="post" action="">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
		...
		<tr align="left" class="dataTr">
			...
			<td class="action endCol"><a href="userfavorite_save.php?action=del2&amp;id=<?php echo $row['id'] ?>" onclick="return ConfDel(0);">删除</a></td>
		</tr>
		<?php
		}
		?>
...
?>
<div class="bottomToolbar"><span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:DelAllNone('userfavorite_save.php');" onclick="return ConfDelAll(0);">删除</a></span></div>
...
<div class="quickToolbar">
	<div class="qiuckWarp">
		<div class="quickArea"><span class="selArea"><span>选择：</span> <a href="javascript:CheckAll(true);">全部</a> - <a href="javascript:CheckAll(false);">无</a> - <a href="javascript:DelAllNone('userfavorite_save.php');" onclick="return ConfDelAll(0);">删除</a></span><span class="pageSmall">
