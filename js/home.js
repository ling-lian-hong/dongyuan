    ...
    window.Rbslider = function(container, params) {
        ...
        function handleKeyboard(e) {
            ...
            if (kc === 37 || kc === 39 || kc === 38 || kc === 40) {
                ...
                var rbsliderCoord = [
                    [rbsliderOffset.left, rbsliderOffset.top],
                    [rbsliderOffset.left + s.width, rbsliderOffset.top],
                    [rbsliderOffset.left, rbsliderOffset.top + s.height],
                    [rbsliderOffset.left + s.width, rbsliderOffset.top + s.height]
                ];
